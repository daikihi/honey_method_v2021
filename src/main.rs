...
use honey_method_v2021::presentations::controllers::{static_files_controller, prefecture_controller, honeies_controller};
...
async fn main()  -> std::io::Result<()> {
    HttpServer::new(|| {
        ...
        .service(honeies_controller::get_all_honeies)
    })
    .bind("127.0.0.1:8080")?
    .run()
    .await
